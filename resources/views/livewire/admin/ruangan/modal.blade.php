                ...
                <div class="modal-body">
                    ...
                    <div class="row col-md-12">
                        <div class="col-md-6">
                            ...
                            <input type="text" name="nama_ruangan" wire:model.defer="nama_ruangan"
                                class="form-control" />
                            @error('nama_ruangan')
                            <span class="text-danger" style="font-size: 12px">{{ $message }}</span>
                            @enderror
                        ...
                        <div class="col-md-6">
                            <label for="">Status Ruangan</label>
                            <input type="text" name="status_ruangan" wire:model.defer="status_ruangan"
                                class="form-control" />
            ...
            <form wire:submit.prevent="update({{$edit_id}})">
                <div class="modal-body">
                    ...
                    <div class="row col-md-12">
                        <div class="col-md-6">
                            <label for="">Nama Ruangan</label>
                            <input type="text" name="nama_ruangan" wire:model.defer="edit_nama_ruangan"
                                class="form-control" />
                        </div>

                        <div class="col-md-6">
                            <label for="">Status Ruangan</label>
                            <input type="text" name="status_ruangan" wire:model.defer="edit_status_ruangan"
                                class="form-control" />
