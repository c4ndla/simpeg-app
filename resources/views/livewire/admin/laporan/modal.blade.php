                ...
                <div class="modal-body">
                    ...
                    <div class="row col-md-12">
                        <div class="col-md-6">
                            ...
                            <input type="text" name="tindakan" wire:model.defer="tindakan" class="form-control" />
                            @error('tindakan')
                            <span class="text-danger" style="font-size: 12px">{{ $message }}</span>
                            @enderror
                        </div>
            ...
            <form wire:submit.prevent="update({{$edit_id}})">
                <div class="modal-body">
                    ...
                    <div class="row col-md-12">
                        <div class="col-md-6">
                            <label for="">Tindakan</label>
                            <input type="text" name="tindakan" wire:model.defer="edit_tindakan" class="form-control" />
                        </div>
