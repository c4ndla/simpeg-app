...
<div class="row" style="padding-top: 20px">
    ...
    <div class="col-lg-4 col-xlg-3 col-md-5">
        <div class="card">
            <div class="card-body">
                <center class="m-t-30"> <img src="{{asset('storage')}}/{{$coba->foto}}" class="img-circle"
                        width="150" />
                    <h4 class="card-title m-t-10">{{ $coba->nama }}</h4>
    ...
    <div class="col-lg-8 col-xlg-9 col-md-7">
        <div class="card">
            ...
            <ul class="nav nav-tabs profile-tab" role="tablist">
                ...
                <li class="nav-item"> <a class="nav-link" data-bs-toggle="tab" href="#profile" role="tab">Profile</a>
                </li>
                    ...
                    <div class="card-body">
                        <div class="profiletimeline">
                            ...
                            <div class="sl-item">
                                ...
                                <div class="sl-left"> <img src="{{asset('storage')}}/{{$item->foto}}" alt="user"
                                        class="img-circle" /> </div>
                                <div class="sl-right">
                                    <div><a href="javascript:void(0)" class="link">{{ $item->nama }}</a> <span
                                            class="sl-date">5
                                            minutes ago</span>
                                        <p>assign a new task <a href="javascript:void(0)"> Design weblayout</a></p>
                                        <div class="row">
                                            <div class="col-lg-3 col-md-6 m-b-20"><img
                                                    src="{{asset('storage')}}/{{$item->ktp}}"
                                                    class="img-responsive radius" />
                                                <a href="{{asset('storage')}}/{{$item->ktp}}"><button
                                                        class="btn btn-success" type="button">Download</button></a>
                                            </div>
                                        </div>
