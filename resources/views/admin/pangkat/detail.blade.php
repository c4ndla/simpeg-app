...
<div class="row" style="padding-top: 20px">
    ...
    <div class="col-lg-4 col-xlg-3 col-md-5">
        <div class="card">
            <div class="card-body">
                <center class="m-t-30"> <img src="{{asset('storage')}}/{{$pangkat->dokumen}}" class="img-circle"
                        width="150" />
                    <h4 class="card-title m-t-10">Golongan : {{ $pangkat->golongan }}</h4>
                    <h6 class="card-subtitle">Angka Kredit : {{ $pangkat->angka_kredit }}</h6>
                    ...
                    <div class="card-body">
                        <div class="profiletimeline">
                            ...
                            <div class="sl-item">
                                ...
                                <div class="sl-left"> <img src="{{asset('storage')}}/{{$pangkat->dokumen}}" alt="user"
                                    ...
                                    <div>
                                        <div class="row justify-content-md-center">
                                            <div class="col-6">
                                                ...
                                                <h6 class="card-title">{{$pangkat->golongan}}</h6>
                                                <small class="text-dark">Angka Kredit</small>
                                                <h6 class="card-title">{{$pangkat->angka_kredit}}</h6>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-3 col-md-6 m-b-20">Dokumen<img
                                                    src="{{asset('storage')}}/{{$pangkat->dokumen}}"
                                                    class="img-responsive radius" />
                                                <a href="{{asset('storage')}}/{{$pangkat->dokumen}}"><button
