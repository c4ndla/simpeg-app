        ...
        <div class="bs-stepper-content">
            ...
            <div id="account-details-modern" class="content" role="tabpanel"
                ...
                <div class="list-group">
                    ...
                    <form action="{{ url('admin/update-personal/'.$personal->id) }}" method="POST"
                        ...
                        <div class="row">
                            <div class="mb-1 col-md-12 ">
                                ...
                                <input type="text" id="modern-username" value="{{ $personal->NIP }}" name="NIP"
                        ...
                        <div class="row">
                            <div class="mb-1 col-md-6">
                                ...
                                <input type="text" id="modern-username" value="{{ $personal->nama_depan }}"
                                    name="nama_depan" class="form-control" placeholder="Nama Depan" />
                            </div>
                            <div class="mb-1 col-md-6">
                                <label class="form-label" for="modern-username">Nama Belakang</label>
                                <input type="text" id="modern-username" value="{{ $personal->nama_belakang }}"
                                    name="nama_belakang" class="form-control" placeholder="Nama Belakang" />
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="mb-1 col-md-6">
                                ...
                                <input type="text" id="modern-username" value="{{ $personal->gelar_depan }}"
                                    name="gelar_depan" class="form-control" placeholder="Gelar Depan" />
                            </div>
                            <div class="mb-1 col-md-6">
                                <label class="form-label" for="modern-username">Gelar Belakang</label>
                                <input type="text" id="modern-username" value="{{ $personal->gelar_belakang }}"
                                    name="gelar_belakang" class="form-control" placeholder="Gelar Belakang" />
                            </div>
                        </div>
                            ...
                            <div class="mb-1 col-md-6">
                                ...
                                <div class="mb-1">
                                    ...
                                    <select class="form-select" id="basicSelect" name="agama_id">
                                        ...
                                        <option value="{{ $agamaitem->id }}" {{ $personal->agama_id == $agamaitem->id ?
                                            'selected':'' }}>
                                            {{ $agamaitem->nama }}</option>
                        ...
                        <div class="row">
                            <div class="mb-1 col-md-6">
                                ...
                                <input type="text" id="modern-username" class="form-control" placeholder="Tempat Lahir"
                                    name="tempat" value="{{ $personal->tempat }}" />
                            </div>
                            <div class="col-md-6 mb-1">
                                ...
                                <input type="text" id="fp-default" class="form-control flatpickr-basic"
                                    placeholder="YYYY-MM-DD" name="tgl_lahir" value="{{ $personal->tgl_lahir }}" />
                            </div>
                        </div>
                            ...
                            <div class="col-12">
                                <div class="mb-1">
                                    ...
                                    <textarea class="form-control" id="exampleFormControlTextarea1" name="alamat"
                                        rows="3" placeholder="Alamat" value="{{ $personal->alamat }}"></textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="mb-1 col-md-3">
                                ...
                                <input type="text" id="modern-username" class="form-control" name="kecamatan"
                                    placeholder="Kecamatan" value="{{ $personal->kecamatan }}" />
                            </div>
                            <div class="mb-1 col-md-3">
                                <label class="form-label" for="modern-username">RT</label>
                                <input type="text" id="modern-username" class="form-control" name="rt" placeholder="RT"
                                    value="{{ $personal->rt }}" />
                            </div>
                            <div class="mb-1 col-md-3">
                                <label class="form-label" for="modern-username">RW</label>
                                <input type="text" id="modern-username" class="form-control" name="rw" placeholder="RW"
                                    value="{{ $personal->rw }}" />
                            </div>
                            <div class="mb-1 col-md-3">
                                ...
                                <input type="text" id="modern-username" class="form-control" name="kode_pos"
                                    placeholder="Kode Pos" value="{{ $personal->kode_pos }}" />
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="mb-1 col-md-6">
                                ...
                                <input type="text" id="modern-username" class="form-control" name="no_telp"
                                    placeholder="No. Telepon" value="{{ $personal->no_telp }}" />
                            </div>
                            <div class="mb-1 col-md-6">
                                ...
                                <input type="text" id="modern-username" class="form-control" name="no_hp"
                                    placeholder="No. Handphone" value="{{ $personal->no_hp }}" />
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="mb-1 col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="checkbox" name="status" {{ $personal->status == '1' ? 'checked':''
                                    }}>
                                </div>
                            </div>
                        </div>
