    ...
    <div class="col-lg-8 col-xlg-9 col-md-7">
        <div class="card">
            ...
            <ul class="nav nav-tabs profile-tab" role="tablist">
                ...
                {{-- <li class="nav-item"> <a class="nav-link card-title" data-bs-toggle="tab" href="#tab6"
                        role="tab">CPNS &
                        PNS</a>
                </li>
                                    ...
                                    <div>
                                        <div class="row justify-content-md-center">
                                            <div class="col-6">
                                                ...
                                                <h6 class="card-title">Suami/Istri</h6>
                                        ...
                                        <div class="row justify-content-md-center">
                                            <div class="col-12">
                                                ...
                                                <h6 class="card-title">{{ 'Rp. ' . number_format($gajiitem->gaji_pokok
                                                    ??
                                                    '', 0, ',', '.') }}</h6>
                                                <small class="text-dark">Gaji Berkala</small>
                                                <h6 class="card-title">{{ 'Rp. ' . number_format($gajiitem->gaji_berkala
                                                    ??
                                                    '', 0, ',', '.') }}</h6>
