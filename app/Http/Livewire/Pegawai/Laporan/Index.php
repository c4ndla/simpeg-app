...
namespace App\Http\Livewire\Pegawai\Laporan;
...
class Index extends Component
{
    ...
    public $judul, $isi, $dokumen, $pegawai_id, $status;
    ...
    public function render()
    {
        ...
        return view('livewire.pegawai.laporan.index', ['laporan' => $laporan, 'pegawai' => $pegawai]);
    }
}
